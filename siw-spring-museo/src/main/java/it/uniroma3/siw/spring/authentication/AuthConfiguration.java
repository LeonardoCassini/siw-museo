...
public class AuthConfiguration extends WebSecurityConfigurerAdapter
{
	...
	protected void configure(HttpSecurity http) throws Exception
	{
		http
			...
			.antMatchers(HttpMethod.GET, "/","/home","/login","/artisti","/artista/{id}","/artista","/collezioni","/collezione","/collezioni/{id}","/opera","/opera/{id}","/periodi","/anno/{annoRealizzazione}","/informazioni","/css/**","/immagini/**").permitAll()
